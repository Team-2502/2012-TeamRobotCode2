...
void Output::print()
{
	...
	if(!hasPrintedFirstTime) {
		...
		driverStationLCD->Printf(DriverStationLCD::kUser_Line4,1,"Winching:           ");
	...
	driverStationLCD->Printf(DriverStationLCD::kUser_Line4,C_WIDTH,boolToString(winching).c_str());
