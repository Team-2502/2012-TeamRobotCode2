...
void _GLOBAL__I__Z12SetDebugFlag20DebugOutputType_enum();

void _GLOBAL__I_VisionAPI_debugFlag();

void _GLOBAL__I_TrackAPI_debugFlag();

void _GLOBAL__I__ZN9RobotBase10m_instanceE();

void _GLOBAL__I__Z14SetJaguarSpeedjjf();
...
void (*_ctors[])() =
    ...
    _GLOBAL__I__Z12SetDebugFlag20DebugOutputType_enum,
    _GLOBAL__I_VisionAPI_debugFlag,
    _GLOBAL__I_TrackAPI_debugFlag,
    _GLOBAL__I__ZN9RobotBase10m_instanceE,
    _GLOBAL__I__Z14SetJaguarSpeedjjf,
    0
    };
...
void _GLOBAL__D__Z12SetDebugFlag20DebugOutputType_enum();

void _GLOBAL__D_VisionAPI_debugFlag();

void _GLOBAL__D_TrackAPI_debugFlag();

void _GLOBAL__D__ZN9RobotBase10m_instanceE();

void _GLOBAL__D__Z14SetJaguarSpeedjjf();
...
void (*_dtors[])() =
    ...
    _GLOBAL__D__Z12SetDebugFlag20DebugOutputType_enum,
    _GLOBAL__D_VisionAPI_debugFlag,
    _GLOBAL__D_TrackAPI_debugFlag,
    _GLOBAL__D__ZN9RobotBase10m_instanceE,
    _GLOBAL__D__Z14SetJaguarSpeedjjf,
    0
    };
